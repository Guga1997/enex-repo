...
/**
 * ძველი დემო-კატეგორიების გადატანა აღარ არის: დემო-პროდუქტები წაშლილია, მიმწოდებლის
 * პროდუქტს კი შუალედურ კატეგორიაში ყოფნა შეიძლება სწორედ ეძლეოდეს — ფოთოლზე ბრმად გადატანა შეცდომაა.
 */
