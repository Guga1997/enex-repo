...
export default async function ProfilePage() {
  ...
  return (
    <div className="space-y-4">
      <h1 className="text-xl font-bold">პერსონალური ინფორმაცია</h1>
      ...
      <div className="card divide-y divide-line">
        ...
        <div className="flex flex-wrap gap-2 px-4 py-3 text-sm">
          <span className="w-56 shrink-0 text-muted">დადასტურება</span>
      ...
      <form action={setNewsletterAction} className="card space-y-3 p-4">
        <p className="font-medium">სიახლეების გამოწერა</p>
